...
@Configuration
@EnableCassandraRepositories(basePackages = "com.hivemind.user.repository")
public class CassandraConfig extends AbstractCassandraConfiguration
{
    @Value("${spring.data.cassandra.keyspace-name:user_keyspace}")
    ...
    @Override
    public String[] getEntityBasePackages() { return new String[]{"com.hivemind.user.entity"}; }
